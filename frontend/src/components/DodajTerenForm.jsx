                ...
                <form className="w-full max-w-lg">
                    <div className="flex flex-wrap -mx-3 mb-6 w-full">
                        <div className="w-full md:w-1/2 px-3">
                            <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" htmlFor="naziv_terena">
                                Naziv terena
                            </label>
                            <input
                             type="text"
                           ...
                           //  onChange={handleChange}
                            ...
                            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" htmlFor="lokacija_terena">
                                Lokacija terena
                                </label>
                                <input
                                //  type="text"
                    ...
                    <div className="flex flex-wrap -mx-3 mb-2">
                        <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                            <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"  htmlFor="kapacitet_terena" >
                               Kapacitet terena
                            </label>
                            <input 
                             type="number"
                        ...
                        <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                            <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" htmlFor="tip_terena">
                                Tip terena
                            </label>

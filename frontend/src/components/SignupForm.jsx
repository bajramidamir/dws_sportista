...
function SignupForm() {
    ...
    return (
        <div className="px-16 py-6 bg-gray-100 md:col-span-2 min-h-screen flex flex-col">
            ...
            <h5 className="text-2xl font-semibold mb-6 mt-5 border-b-2">Registracija</h5>    
                ...
                <form className="w-full max-w-lg">
                    ...
                    <div className="flex flex-wrap -mx-3 mb-6">
                        <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input
                              ...
                              onChange={handleChange}
                            className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="example123"/>
                        </div>
                        <div className="w-full md:w-1/2 px-3">
                    ...
                    <div className="flex flex-wrap -mx-3 mb-6">
                        <div className="w-full px-3">
                            ...
                            <input 
                              ...
                              onChange={handleChange}
                            className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="******************"/>
                        </div>
                    </div>
                    <div className="flex flex-wrap -mx-3 mb-6">
                        <div className="w-full px-3">
                    ...
                    <div className="flex flex-wrap -mx-3 mb-2">
                        ...
                        <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                            <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" htmlFor="fitness_level">
                                Nivo spretnosti
                            </label>

...
function Home() {
  ...
  return (
    <main className='main-container'>
        ...
        <div className='charts' id='grafovi'>
            ...
            >
                ...
                <Tooltip />
                <Legend />
                <Bar dataKey="gl" fill="rgba(246, 190, 7, 0.8)" />
                <Bar dataKey="kap" fill="rgba(99, 63, 0, 0.8)" />
                </BarChart>
            </ResponsiveContainer>

            <ResponsiveContainer width="100%" height="100%">
                /*ovdje treba biti karta jednog grada sa stadijumima koji tu postoje*/
            </ResponsiveContainer>
